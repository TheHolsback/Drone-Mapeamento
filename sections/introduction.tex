...
Como considerações preliminares, entende-se que o projeto consiste no desenvolvimento de um sistema dedicado à aquisição de dados espaciais de alta precisão, visando à geração de nuvens de pontos detalhadas em ambientes confinados. A proposta fundamenta-se na integração de sensores embarcados, permitindo a reconstrução tridimensional desses ambientes com elevado nível de fidelidade.

A aplicação futura do sistema está direcionada, principalmente, para o mapeamento de cavidades, como cavernas, bem como para atividades de inspeção e levantamento em ambientes de difícil acesso, incluindo operações no setor minerador e em áreas correlatas.
